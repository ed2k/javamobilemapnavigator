...
public class Main {
      ...
      while(nextNorth>maxLat){
        while(nextWest<maxLon){
          ...
          if(imagesRange.size()>0){            
            String fileName  = mapName+"_"+eh.getZoom()+"_"+df6.format(++counter);                                                // ve_"+"z"+eh.getZoom()+"_n"+group_north+"_w"+group_west+"_s"+group_south+"_e"+group_east;
  ...
  public static void prepareForTrekBuddy(final String mapName,final String zoom,int tileSize,int colorType) throws Exception{
      ...
      public boolean accept(File dir, String name) {
        if(name.endsWith(".png") && name.startsWith(mapName+"_"+zoom))
          return true;  
        else
          return false;
      }
  ...
  public static void main(String[] args) throws Exception {
    /*
    // SLOVENIA
    double    minLon         =   13.308342;
    double    maxLon         =   16.744565;
    double    minLat         =   46.966588;
    double    maxLat         =   45.364309;
    // WORLD
    double    minLon         =   -179.000000;
    double    maxLon         =   +179.000000;
    double    minLat         =   + 84.000000;
    double    maxLat         =   - 84.000000;    
    // EUROPE
    double    minLon         =   - 12.672475;
    double    maxLon         =   + 35.170781;
    double    minLat         =   + 62.586125;
    double    maxLat         =   + 32.728137;
    */
